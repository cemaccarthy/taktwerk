// app.js - Step 3 fix: Dropdown positioning
...
function openComposerModal() {
  ...
  catalogueList.innerHTML = ''; addStatusEl.textContent = '';
...
// FIXED: Use position:fixed + match trigger width exactly
...
async function initApp() {
  ...
  selectedComposerDisplay = document.getElementById('selected-composer-display');
  ...
  renderLibrary(await loadSongs());
  console.log('[Taktwerk] Step 3 fix: Dropdown positioned correctly');
}
